        ...
        <div className="containerAboutUsSection">
            <div className="contentAboutUs">
                <div className="aboutUsSection">
                    <h1 className="aboutUsSectionTitle">About Us</h1>
                    <p className="aboutUsSectionDescription aboutUsSectionDescriptionFirst">
                        Welcome to Takeouts - your ultimate destination for
                        nutritious and mouthwatering meals. Founded by Eli and Tsveti, a
                        passionate chefs and nutrition enthusiast, our mission is to inspire
                        people to lead healthier lives through wholesome cooking.
                    </p>
                    <br />
                    <p className="aboutUsSectionDescription">
                        At Takeouts, we believe that eating well should never mean
